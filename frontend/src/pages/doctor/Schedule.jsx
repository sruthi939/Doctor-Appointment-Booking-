            ...
            <div className='space-y-6 text-left animate-in fade-in duration-300 max-w-4xl mx-auto'>
                <div className='bg-slate-900/80 border border-slate-800 rounded-3xl p-6 sm:p-8 backdrop-blur-md shadow-xl flex flex-col sm:flex-row sm:items-center justify-between gap-4'>
                    <div>
                        ...
                        <p className='text-slate-400 text-sm mt-1'>
                            Set available working days and time slots for patient appointments.
                        </p>
                    </div>

                    <button
                        onClick={handleSaveSchedule}
                        className='px-6 py-2.5 bg-gradient-to-r from-pink-500 to-rose-600 hover:from-pink-600 hover:to-rose-700 text-white rounded-xl text-xs font-bold transition-all shadow-md shadow-pink-500/20 flex items-center gap-2 cursor-pointer self-start sm:self-auto'
                    >
                            ...
                            return (
                                <button
                                    ...
                                    className={`px-5 py-3 rounded-2xl text-xs font-bold transition-all border cursor-pointer ${
                                        isSelected
                                            ? 'bg-gradient-to-r from-pink-500 to-rose-600 border-pink-500 text-white shadow-md shadow-pink-500/20'
                ...
                <div className='bg-slate-900/90 border border-slate-800 rounded-3xl p-6 backdrop-blur-md shadow-xl space-y-5'>
                    <div className='flex items-center justify-between border-b border-slate-800 pb-3'>
                        <h2 className='text-base font-bold text-white uppercase tracking-wider text-indigo-400'>
                    ...
                    <form onSubmit={handleAddSlot} className='pt-4 border-t border-slate-800 flex flex-col sm:flex-row items-end gap-3'>
                        ...
                        <button
                            type='submit'
                            className='w-full sm:w-auto px-6 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl text-xs transition-colors flex items-center justify-center gap-1.5 cursor-pointer shadow-md shadow-indigo-600/20 shrink-0'
                        >
